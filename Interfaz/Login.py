...
frame1 = Frame(ventana,bg="medium orchid")
frame2 = Frame(ventana,bg="honeydew4")

imagen = Image.open("\\Users\\Usuario\\OneDrive\\Escritorio\\Nueva carpeta\\logo tecnar.png")
imagen = imagen.resize((300,300))
imagen = ImageTk.PhotoImage(imagen)
label = Label(image=imagen,background="medium orchid")
label.place(x=60,y=100)

frame1.place(x=0,y=0,width=400,height=800)
frame2.place(x=400,y=0,width=400,height=800)

titulo = Label(ventana, text="Inicio Sesion", bg= "honeydew4",font= "helvetica 14")
titulo.place(x=500, y=80, width=200)


usuario = Label(ventana, text= "usuario: ", bg="honeydew4",font= "helvetica 14")
usuario.place(x=410, y= 140, width=200)
medidas1= Entry(ventana, bg="white",bd= 3)
medidas1.place(x= 600, y=140,width=120)

contraseña = Label(ventana, text= "contraseña: ", bg="honeydew4",font= "helvetica 14")
